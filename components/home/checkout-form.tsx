...
//     try {
//       // ✅ Create order directly using API
//       const orderData = {
//         userId,
//         items,
//       }
...
//     <div className="fixed inset-0 z-50 overflow-hidden">
//       <div className="absolute inset-0 bg-black bg-opacity-50" onClick={onClose} />
//       <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-lg shadow-xl max-h-[90vh] overflow-y-auto">
//         <div className="flex items-center justify-between p-6 border-b border-gray-200">
//           <h2 className="text-xl font-semibold text-gray-900">Checkout</h2>
//           <Button variant="ghost" size="icon" onClick={onClose}>
//             <X className="w-5 h-5" />
...
//               className="bg-green-600 hover:bg-green-700 text-white px-8"
//             >
//               {isProcessing ? "Processing..." : `Proceed to Checkout (৳${cartTotal + 50})`}
//             </Button>
//           </div>
//         </form>
//       </div>
