    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (catRes?.data && prodRes?.data) {
          const categoryMap: Record<string, { id: number; name: string; count: number }[]> = {}
...
//                         {/* Subcategories Side Menu */}
//                         {hoveredCategory === category.name && (
//                           <div className=" overflow-y-scroll max-h-[60vh] absolute left-full top-0 min-w-96 bg-white border border-gray-200 rounded-lg shadow-lg z-50 ml-1">
//                             <div className="p-2">
//                               <h4 className="text-sm font-semibold text-gray-800 px-3 py-2 border-b border-gray-100 mb-2">
//                                 {category.name}
//                               </h4>
